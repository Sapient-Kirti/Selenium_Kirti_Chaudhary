...
public class SeleniumDay1Assignment {
	...
	public static void main(String[] args ) throws InterruptedException {
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='systemUser_userName']")).sendKeys("ABCDEF");
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[@href='/orangehrm-4.9/symfony/web/index.php/auth/logout']")).click();
		
		driver.findElement(By.xpath("//input[@id='txtUsername']")).sendKeys("ABCDEF");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='txtPassword']")).sendKeys("Kirti@123");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//input[@id='btnLogin']")).click();
